...
Sanitized, allowlisted evidence template. Governance publication performed no Railway requests, DNS lookup, TCP check or HTTPS probe.
...
next_authorized_gate=NONE
next_approvable_gate=RAILWAY-ENDPOINT-TRANSPORT-DIAGNOSTIC-READONLY
